...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(major) {
  ...
  // Then we add the major earthquakes layer to our map.
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(plates) {
    ...
    function styleInfoPlates(feature) {
      return {
        color: "red",
        weight: 1.5
      };
    ...
    console.log(plates)
        ...
        L.geoJson(plates, {style: styleInfoPlates}
